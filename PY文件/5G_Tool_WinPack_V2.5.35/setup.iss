; Inno Setup Script for 5G User Data Voice Tool V2.5.35
; Download Inno Setup: https://jrsoftware.org/isdl.php
; Build: ISCC.exe setup.iss

#define MyAppName "5G User Data Voice Tool"
#define MyAppVersion "2.5.35"
#define MyAppExeName "5G_UserDataVoiceTool_V2.5.35.exe"
#define MyDistDir "dist\5G_UserDataVoiceTool_V2.5.35"
